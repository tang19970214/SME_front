  ...
  <div v-if="show">
    <el-form label-position="top">
      ...
      <el-form-item :label="'大小'" v-if="Object.keys(data.options).indexOf('size')>=0">
        寬度 <el-input size="small" style="width: 90px;" type="number" v-model.number="data.options.size.width"></el-input>
        高度 <el-input size="small" style="width: 90px;" type="number" v-model.number="data.options.size.height"></el-input>
      </el-form-item>
      ...
      <el-form-item label="'允許半邊'" v-if="Object.keys(data.options).indexOf('allowHalf')>=0">
        <el-switch v-model="data.options.allowHalf" size="small">
        </el-switch>
      </el-form-item>
      <el-form-item :label="'支持透明度選擇'" v-if="Object.keys(data.options).indexOf('showAlpha')>=0">
        <el-switch v-model="data.options.showAlpha" size="small">
        </el-switch>
      </el-form-item>
      <el-form-item :label="'是否顯示標籤'" v-if="Object.keys(data.options).indexOf('showLabel')>=0">
        <el-switch v-model="data.options.showLabel" size="small">
        </el-switch>
      </el-form-item>
      <el-form-item :label="'選項'" v-if="Object.keys(data.options).indexOf('options')>=0">
        <template>
          ...
          <div style="margin-left: 22px;">
            <el-button type="text" @click="handleAddOption">添加選項</el-button>
          </div>
        </template>

      </el-form-item>

      <el-form-item :label="'默認值'" v-if="Object.keys(data.options).indexOf('defaultValue')>=0 && (data.type == 'textarea' || data.type == 'input' ||  data.type == 'text' || data.type=='rate' || data.type=='color' || data.type=='switch')">
      ...
      <template v-if="data.type == 'time' || data.type == 'date'">
        ...
        <el-form-item :label="'是否為範圍選擇'" v-if="data.type == 'time'">
          <el-switch v-model="data.options.isRange" size="small">
          </el-switch>
        </el-form-item>
        <el-form-item :label="'是否獲取時間戳'" v-if="data.type == 'date'">
          <el-switch v-model="data.options.timestamp" size="small">
          </el-switch>
        </el-form-item>
        ...
        <el-form-item :label="'默認值'" v-if="data.type=='time' && Object.keys(data.options).indexOf('isRange')>=0">
          <el-time-picker key="1" style="width: 100%;" v-if="!data.options.isRange" v-model="data.options.defaultValue" :arrowControl="data.options.arrowControl" :value-format="data.options.format" size="small">
          </el-time-picker>
          <el-time-picker key="2" v-if="data.options.isRange" style="width: 100%;" v-model="data.options.defaultValue" is-range :arrowControl="data.options.arrowControl" :value-format="data.options.format" size="small">
          </el-time-picker>
        </el-form-item>
      </template>
