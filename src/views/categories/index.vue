    ...
    <div class="categories-box">
      <div class="categories-container flex-row">
        ...
        <el-main class="categories-content flex-item">
          ...
          <el-table height="calc(100% - 52px - 44px)" ref="mainTable" :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row style="width: 100%;" @row-click="rowClick" @selection-change="handleSelectionChange">
            <el-table-column type="selection" align="center" width="55"></el-table-column>
            <el-table-column label="名稱" prop="name" align="center" min-width="150"></el-table-column>
            <el-table-column label="代碼" prop="dtCode" align="center" min-width="150"></el-table-column>
            <el-table-column label="值" prop="dtValue" align="center" min-width="150"></el-table-column>
            <el-table-column label="是否可用" align="center" width="100">
              <template slot-scope="scope">
                <span>{{scope.row.enable ? "是" : "否"}}</span>
              </template>
            </el-table-column>
            <el-table-column label="分類標識" prop="typeId" align="center" min-width="200"></el-table-column>
            <el-table-column label="創建日期" prop="createTime" align="center" min-width="200"></el-table-column>
          </el-table>
          <pagination v-show="total>0" :total="total" :page.sync="listQuery.page" :limit.sync="listQuery.limit" @pagination="handleCurrentChange" />
        </el-main>
      </div>

      <el-dialog :destroy-on-close="true" class="dialog-mini custom-dialog user-dialog" width="400px" title="添加分組" :visible.sync="addTypesDialog">
  ...
  methods: {
    ...
    getList() {
      ...
      categorys.getList(this.listQuery).then((response) => {
        ...
        this.list = response.data.map((it) => {
          it.enable = it.enable ? "是" : "否";
          return it;
        });
