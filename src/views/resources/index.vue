  ...
  <div class="flex-column">
    <sticky :className="'sub-navbar'">
      <div class="filter-container">
        ...
        <el-select clearable size="mini" class="filter-item" style="width: 200px" v-model="listQuery.appId" :placeholder="'所屬應用'">
          <el-option value="" label="">請選擇</el-option>
    ...
    <div class="app-container flex-item">
      ...
      <el-dialog v-el-drag-dialog class="dialog-mini" width="500px" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
        <el-form :rules="rules" ref="dataForm" :model="temp" label-position="right" label-width="100px">
          <el-form-item size="small" :label="'所屬應用'" prop="appId">
            <el-select class="filter-item" v-model="temp.appId" placeholder="請選擇" @change="changeApp">
