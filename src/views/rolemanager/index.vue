<template>
  <div class="flex-column">
    ...
    <div class="app-container flex-item">
      ...
      <!-- 添加角色用戶 -->
      <el-dialog class="dialog-mini user-dialog" v-el-drag-dialog :title="'添加角色用戶'" :visible.sync="roleUsers.dialogUserResource" :close-on-click-modal="false" :close-on-press-escape="false">
        <selectUsersCom ref="selectUser" v-if="roleUsers.dialogUserResource" :hiddenFooter="true" :loginKey="'loginUser'" :selectUsers.sync="roleUsers.rowIndex > -1 && roleUsers.list[roleUsers.rowIndex]">
        </selectUsersCom>
